...
import os
import argparse
# from meta_attacks.MetaDIM import MetaDIM     #精度高
from SM_attacks.smdim import MetaDIM     #精度高
from run_attacks.utils import save_images, run
...
parser.add_argument('--output', help='output dir', type=str, default='../output/meta_dim_lfw_d')
