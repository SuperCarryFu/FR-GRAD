...
from networks.config import THRESHOLD_DICT


parser = argparse.ArgumentParser()
parser.add_argument('--dataset', help='dataset', type=str, default='lfw', choices=['lfw', 'ytf', 'cfp'])
parser.add_argument('--model', help='White-box model', type=str, default='FaceNet-VGGFace2')
...
parser.add_argument('--anno', help='output dir', type=str, default='../output/TIM-gs-1/annotation.txt')
parser.add_argument('--log', help='log run_attacks', type=str, default='TIM-gs-1.txt')
args = parser.parse_args()
# FaceNet-casia CosFace SphereFace FaceNet-VGGFace2 MobileFace
# IR50-Softmax-BR IR50-Softmax-RP IR50-Softmax-JPEG
# IR50-PGDSoftmax IR50-PGDCosFace IR50-PGDAm IR50-PGDArcFace IR50-PGDSphereFace
# IR50-TradesSoftmax IR50-TradesCosFace IR50-TradesArcFace
'''
    'IR50-PGDArcFace''IR50-TradesArcFace'
    'IR50-Softmax-BR''IR50-Softmax-JPEG''IR50-Softmax-RP'
'''
...
with open(args.anno, 'r') as f:
    for line in tqdm(f.readlines()):
        ...
        # adv_img = imread(adv_img_path).astype(np.float32)
