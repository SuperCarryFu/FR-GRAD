...
import os
import argparse
# from meta_attacks.MetaTIM import MetaTIM
...
parser.add_argument('--kernel_len', help='kernel_len', type=int, default=7)
parser.add_argument('--nsig', help='nsig', type=int, default=3)
...
parser.add_argument('--output', help='output dir', type=str, default='../output/meta_tim_lfw_d')
