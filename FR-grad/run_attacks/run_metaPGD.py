...
import os
import argparse
# from meta_attacks.MetaPGD import MetaPGD
...
parser.add_argument('--output', help='output dir', type=str, default='../output/test_hj')
...
def main():
    ...
    models = ['MobilenetV2-stride1', 'ShuffleNet_V1_GDConv',
              'ArcFace', 'ShuffleNet_V2_GDConv-stride1',
              'ResNet50', 'IR50-CosFace', 'IR50-ArcFace',
              'IR50-SphereFace', 'Mobilenet-stride1']

    # models = ['IR50-Softmax-JPEG',
    #           'IR50-CosFace',
    #           'IR50-SphereFace',
    #           'IR50-Am',
    #           'ArcFace',
