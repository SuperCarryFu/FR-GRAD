...
class MetaDIM(ConstrainedMethod):
    def __init__(self, model,goal, distance_metric, eps=1.6,iters=20):
        super(MetaDIM, self).__init__(model,goal, distance_metric, eps)
        self.iters=iters
    ...
    def attack(self, src,dict, models):
        ...
        for _ in range(self.iters):
            ...
            for i in train_index:
                feature1=models[i].forward(Resize_and_Padding(tmp, scale_factor))
            ...
            feature1 = model.forward(Resize_and_Padding(tmp, scale_factor))
